        ...
        <flux:sidebar sticky stashable class="border-e border-zinc-200 bg-zinc-50 dark:border-zinc-700 dark:bg-zinc-900">
            ...
            <flux:navlist variant="outline">
                <flux:navlist.group :heading="__('Platform')" class="grid">
                    ...
                    <flux:navlist.item icon="home" :href="route('balances.index')" :current="request()->routeIs('balances')" wire:navigate>{{ __('Balances') }}</flux:navlist.item>
                    @if(auth()->user()->is_admin == 1)
                        ...
                        <flux:navlist.item icon="home" :href="route('users.index')" :current="request()->routeIs('users')" wire:navigate>{{ __('Users') }}</flux:navlist.item>
                    @endif
                    <flux:navlist.item icon="home" :href="route('stats.index')" :current="request()->routeIs('stats')" wire:navigate>{{ __('Stats') }}</flux:navlist.item>
                </flux:navlist.group>
            </flux:navlist>
