...
<!-- {{ var_dump($tags) }} -->
    ...
    <div class="flex flex-row justify-start items-start gap-1 text-sm py-3 px-4 text-slate-500">
        <a href="/tags" class="font-bold text-black border-b-2 border-b-orange-600">Tags</a>
    </div>
