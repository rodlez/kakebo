<div class="max-w-7xl mx-auto sm:pb-8 sm:px-6 lg:px-8">
    ...
    <div class="flex flex-row justify-start items-start gap-1 text-sm py-3 px-4 text-slate-500">
        <a href="/balances" class="hover:text-green-600">Balances</a> /
        <a href="/balances/show/{{ $balance->id }}" class="hover:text-green-600">Info</a> /
    ...
    <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
        ...
        <div class="flex flex-row justify-between items-center py-4 bg-yellow-600">
            <span class="text-lg text-white px-4">Edit Balance</span>
        </div>
