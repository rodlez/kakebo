                ...
                <div class="flex flex-col md:flex-row gap-2">
                    ...
                    <div class="flex flex-row justify-start items-center p-0 w-full">
                        <input wire:model="value" name="value" id="value" type="any" value="{{ old('value') }}"
                                    maxlength="8"
                                    class="w-full md:w-24 rounded-sm bg-zinc-100 border-1 border-zinc-300 text-gray-900 p-2 focus:border-black focus:outline-hidden focus:ring-green-400 focus:border-green-400">
                    </div>
